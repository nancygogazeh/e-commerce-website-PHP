...
<head>
  <meta charset="utf-8">
  <title><?php echo $product_name ?> | Metronic Shop UI</title>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="./admin/images/<?php echo $product_image?>" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="./image/<?php echo $product_image?>">
                  </div>
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="review">
                    ...
                    <a href="javascript:;"><?php echo count($comments) ?> reviews</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:;">Write a review</a>
                  </div>
