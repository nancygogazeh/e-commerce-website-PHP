...
<br/><div class="container">
  ...
  <p class="centered">20% Off on Adults <br> Books  </br>Use adult 20 to get discount on your book<button class= "btn btn-light"> Shop Now</button>
</p>
...
<div class="container">
  <img style= "opacity: 0.8;height:250px;width:1100px;" src="./image/1.jpg" alt="shop" >
  
  <div class="top-left">Limited time offer Best Offer <br/> <h3>SPECIAL BOOKS</h3><br/><h5>choose abook to read to your holiday,</h5><h3> BUY ANY BOKK BY 20%DISCOUNT</h3><button class=" btn btn-light"> Shop Now </button></div></div>
...
<div class="container text-center">
  <div class="row">
    ...
    <img style="width:30px; height:30px; border-radius: 50%;" src= "./image/5.jpg"><p>ahmed</p>
    </div>
    <div class="col">
    <div class="col">
    <p> It was a Great Experience </p>
